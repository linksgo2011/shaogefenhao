module.exports = [
    {text: '首页', link: '/'},
    {
        text: '建模', link: '/pages/modeling/', items: [
            {text: '领域驱动设计(DDD)基础', link: '/pages/modeling/ddd-foundamental/'},
            {text: 'DDD 概念的解释和理解', link: '/pages/modeling/ddd-concepts/'},
            {text: '在分布式系统中使用 DDD', link: '/pages/modeling/ddd-distribution-architecture/'},
            {text: 'DDD 指导团队划分问题', link: '/pages/modeling/ddd-guide-team/'},
            {text: 'DDD落地，如何持久化聚合', link: '/pages/modeling/ddd-implement-repository/'},
            {text: 'DDD 就是把面向对象做好', link: '/pages/modeling/ddd-is-base-on-oo/'},
            {text: '基于 DDD 理论基础的分层架构', link: '/pages/modeling/ddd-layer/'},
            {text: '主客体思维指导多对多关系建模', link: '/pages/modeling/ddd-many-to-many-relation/'},
            {text: 'DDD 指导微服务分布式授权设计', link: '/pages/modeling/ddd-micro-service-authorize-issue/'},
            {text: 'DDD 指导微服务联表查询问题', link: '/pages/modeling/ddd-micro-service-query-issue/'},
            {text: 'DDD 指导微服务事务问题', link: '/pages/modeling/ddd-micro-service-transaction-issue/'},
            {text: 'DDD 中的几个困难问题', link: '/pages/modeling/ddd-questions/'},
